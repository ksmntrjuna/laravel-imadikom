...
<div class="container mx-auto px-4">
    <div class="grid grid-cols-1 gap-6 md:grid-cols-1 lg:grid-cols-1">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mt-6"> <!-- Tambahkan kelas mt-6 di sini -->
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI BPH</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI HUMAS</h1>
            <img src="{{ asset('images/humas.jpg') }}" alt="Divisi Humas" class="w-1/3 h-auto mb-4 mx-auto rounded-lg">
        ...
        <!-- DIVISI KWU -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI KWU</h1>
            <img src="{{ asset('images/humas.jpg') }}" alt="Divisi Humas" class="w-1/3 h-auto mb-4 mx-auto rounded-lg">
        ...
        <!-- DIVISI MULTIMEDIA -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI MULTIMEDIA</h1>
            <img src="{{ asset('images/humas.jpg') }}" alt="Divisi Humas" class="w-1/3 h-auto mb-4 mx-auto rounded-lg">
        ...
        <!-- DIVISI PSDM -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI PSDM</h1>
            <img src="{{ asset('images/humas.jpg') }}" alt="Divisi Humas" class="w-1/3 h-auto mb-4 mx-auto rounded-lg">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h1 class="text-3xl font-bold mb-4 text-center font-mono">DIVISI SOSMA</h1>
            <img src="{{ asset('images/humas.jpg') }}" alt="Divisi Humas" class="w-1/3 h-auto mb-4 mx-auto rounded-lg">
