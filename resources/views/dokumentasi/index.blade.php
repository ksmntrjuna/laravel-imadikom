        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <!-- Menggunakan nl2br() untuk mempertahankan baris baru dan e() untuk melindungi dari XSS -->
...
<div class="container mx-auto px-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-4">
        <h3 class="text-xl font-semibold">{{ $d->nama }}</h3>
        <img src="{{ $d->getFotoUrlAttribute() }}" alt="Foto Dokumentasi" class="max-w-xs max-h-24">
        <p class="text-gray-600 mt-2">{{ $d->deskripsi }}</p>
        <p class="text-gray-500 mt-2">Tanggal: {{ $d->tanggal }}</p>
