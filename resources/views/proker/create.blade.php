...
<div class="container mx-auto px-4">
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <!-- Tombol Kembali -->
        <a href="{{ route('proker.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 mb-4 inline-block">Kembali</a>
        ...
        <form action="{{ route('proker.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" class="form-input w-full border border-gray-300 p-2 rounded" required>
            </div>

            <!-- Deskripsi -->
            <div class="mb-4">
                <label for="deskripsi" class="block font-semibold mb-2">Deskripsi:</label>
                <textarea name="deskripsi" id="deskripsi" class="form-textarea w-full border border-gray-300 p-2 rounded" rows="4" required></textarea>
            </div>
